...
public:
	...
	public:
		...
		void operator()(Binder::UniformInfo uniform, GLint value1) const {
			...
			LOG::SPEC::debug<&glUniform1i>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, value1));
		}
		void operator()(Binder::UniformInfo uniform, GLint value1, GLint value2) const {
			...
			LOG::SPEC::debug<&glUniform2i>(this, &shader, std::format("shader of id {} with uniform {}, was set to {{{}, {}}}", shader->getShaderID(), uniform.name, value1, value2));
		}
		void operator()(Binder::UniformInfo uniform, GLint value1, GLint value2, GLint value3) const {
			...
			LOG::SPEC::debug<&glUniform3i>(this, &shader, std::format("shader of id {} with uniform {}, was set to {{{}, {}, {}}}", shader->getShaderID(), uniform.name, value1, value2, value3));
		}
		void operator()(Binder::UniformInfo uniform, GLint value1, GLint value2, GLint value3, GLint value4) const {
			...
			LOG::SPEC::debug<&glUniform4i>(this, &shader, std::format("shader of id {} with uniform {}, was set to {{{}, {}, {}, {}}}", shader->getShaderID(), uniform.name, value1, value2, value3, value4));
		}
		void operator()(Binder::UniformInfo uniform, GLuint value1) const {
			glUniform1ui(shader->uniformLocationCache[uniform.name], value1);
			LOG::SPEC::debug<&glUniform1ui>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, value1));
		}
		void operator()(Binder::UniformInfo uniform, GLuint value1, GLuint value2) const {
			...
			LOG::SPEC::debug<&glUniform2ui>(this, &shader, std::format("shader of id {} with uniform {}, was set to {{{}, {}}}", shader->getShaderID(), uniform.name, value1, value2));
		}
		void operator()(Binder::UniformInfo uniform, GLuint value1, GLuint value2, GLuint value3) const {
			...
			LOG::SPEC::debug<&glUniform3ui>(this, &shader, std::format("shader of id {} with uniform {}, was set to {{{}, {}, {}}}", shader->getShaderID(), uniform.name, value1, value2, value3));
		}
		void operator()(Binder::UniformInfo uniform, GLuint value1, GLuint value2, GLuint value3, GLuint value4) const {
			...
			LOG::SPEC::debug<&glUniform4ui>(this, &shader, std::format("shader of id {} with uniform {}, was set to {{{}, {}, {}, {}}}", shader->getShaderID(), uniform.name, value1, value2, value3, value4));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::vec1& value) const {
			...
			LOG::SPEC::debug<&glUniform1fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::vec2& value) const {
			...
			LOG::SPEC::debug<&glUniform2fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::vec3& value) const {
			...
			LOG::SPEC::debug<&glUniform3fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::vec4& value) const {
			...
			LOG::SPEC::debug<&glUniform4fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::ivec1& value) const {
			...
			LOG::SPEC::debug<&glUniform1iv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::ivec2& value) const {
			...
			LOG::SPEC::debug<&glUniform2iv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::ivec3& value) const {
			...
			LOG::SPEC::debug<&glUniform3iv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::ivec4& value) const {
			...
			LOG::SPEC::debug<&glUniform4iv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::uvec1& value) const {
			...
			LOG::SPEC::debug<&glUniform1uiv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::uvec2& value) const {
			...
			LOG::SPEC::debug<&glUniform2uiv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::uvec3& value) const {
			...
			LOG::SPEC::debug<&glUniform3uiv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, const glm::uvec4& value) const {
			...
			LOG::SPEC::debug<&glUniform4uiv>(this, &shader, std::format("shader of id {} with uniform {}, was set to {}", shader->getShaderID(), uniform.name, glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat2& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix2fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat3& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix3fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat4& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix4fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat2x3& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix2x3fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat3x2& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix3x2fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat2x4& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix2x4fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat4x2& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix4x2fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat3x4& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix3x4fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
		void operator()(Binder::UniformInfo uniform, GLsizei count, GLboolean transpose, const glm::mat4x3& value) const {
			...
			LOG::SPEC::debug<&glUniformMatrix4x3fv>(this, &shader, std::format("shader of id {} with uniform {}, was set to a {} value of {}", shader->getShaderID(), uniform.name, (transpose ? "transposed" : ""), glm::to_string(value)));
		}
	private:
		Shader* shader;
