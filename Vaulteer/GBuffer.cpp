...
bool GBuffer::init()
{
    ...
    initTexture(textures[Color], GL_RGBA, GL_RGBA, GL_UNSIGNED_BYTE); // intention is to combine color and specular data into single texture here - specular(last byte) currently not implemented
